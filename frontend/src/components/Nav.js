                ...
                <Router>
                        <div className="nav-wrapper flex column" > 
                                        ...
                                        <div className={`dropdown-wrapper ${open ? "open" : ""}`}>
                                            ...
                                            {projects?.map((project, index) => (
                                                <Link  to={ `/projects/${project.slug}` } key={index} className="dropdown-item ">
                                                    <p className='link'>{project.Project_Title}</p>
                                                </Link>
                                            ))}
                                            </div>
                                        </div>
                            ...
                            <div className="bottom-nav-container">
                                <div>
                                    <Link to={ `mailto:studio@studiorawls.com`} >
                                    ...
                                    <Link to={ "https://www.instagram.com/willjrawls/?hl=en" }>
                        ...
                        <div className="nav-wrapper-mobile flex" > 
                            <div className="mobile-column ">
                                <svg className="menu-icon" width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_312_3731)">
                                    <path d="M14.5817 0H8.19312C2.45015 0 0.139365 2.75113 0.139365 7.3703C0.139365 11.9895 2.17829 13.8236 7.37755 14.2311L15.0575 14.8085C15.6939 14.8548 16.1511 14.966 16.4631 15.1914V11.6931H21.3627C20.2073 10.529 18.3754 9.90528 15.7371 9.71385L8.05719 9.13645C6.66392 9.03456 6.12021 8.62698 6.12021 7.40426C6.12021 6.18154 6.76587 5.77397 8.26108 5.77397H14.5817C15.6352 5.77397 16.2469 6.18154 16.4847 7.09858C16.6547 7.74391 16.9265 8.08355 17.5382 8.08355H21.5821C22.2277 8.08355 22.6355 7.70994 22.6015 7.03065C22.2617 2.51337 19.713 0 14.5817 0ZM22.0825 12.6194H17.3899V23.7782C21.3349 23.065 22.9753 20.4991 22.9753 16.6086C22.9753 14.9629 22.6942 13.6445 22.0825 12.6194ZM14.8536 18.205H8.02321C6.96976 18.205 6.35809 17.7974 6.12021 16.8804C5.9503 16.235 5.67844 15.8954 5.06677 15.8954H1.0229C0.37724 15.8954 -0.030545 16.269 0.00343711 16.9483C0.343258 21.4656 2.89191 23.9789 8.02321 23.9789H14.9216C15.4653 23.9789 15.9812 23.9542 16.4631 23.9048V17.8622C16.114 18.1062 15.5858 18.205 14.8536 18.205Z" fill="white"/>
                                    <path d="M35.5145 30.2161C37.507 29.4102 38.7613 27.9436 39.4224 26.0076H29.9476V25.1893H22.9751V18.1587H29.7715C29.8302 18.1587 29.892 18.1587 29.9476 18.1618V12.6194H17.3896V36.2402C17.541 36.3204 17.7264 36.3637 17.9457 36.3637H21.9556C22.6013 36.3637 22.9751 35.9901 22.9751 35.3447V30.8954H29.4996L32.4901 35.6844C32.7619 36.1599 33.1697 36.3637 33.7134 36.3637H38.301C39.1166 36.3637 39.4224 35.8542 38.9466 35.1409L35.5145 30.2161ZM33.145 12.8448C32.4314 12.7182 31.6559 12.641 30.8188 12.6194L30.8713 18.1896C32.8299 18.3254 33.9142 18.9615 33.9142 21.4193V21.9627C33.9142 24.0994 33.0369 24.8404 31.5478 25.0813H39.6819C39.8951 24.1488 39.997 23.1268 39.997 22.0306V21.3853C39.997 16.4883 37.8685 13.6785 33.145 12.8448Z" fill="white"/>
                                    </g>
                                    <defs>
                                    <clipPath id="clip0_312_3731">
                                 ...
                                 <div>
                                    {mobileOpen ? (
                                        <span className="close-icon" onClick={() => setMobileOpen(!mobileOpen)}>×</span>
                                        ) : (
                            ...
                            <div className={`flex column row-gap-50 mobile-column-dropdown menu-container menu-content ${mobileOpen ? "mobileOpen" : ""}`} >
                                    {/* <Link to={ "/events" }>
                                        <h6>Events</h6>
                                    </Link> */}
